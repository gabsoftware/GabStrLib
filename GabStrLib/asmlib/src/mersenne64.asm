...
ENDIF
        ...
        ?Windows_MersRandomInit LABEL NEAR
...
; rcx unchanged by procedure
        ...
        push    rcx
        mov     rdi, rcx                    ; Pthis
        mov     ecx, (type CRandomMersenneA) / 4
        xor     eax, eax
        cld
        rep     stosd
        pop     rcx                         ; Pthis
...
?Windows_MersRandomInitByArray LABEL NEAR
...
ENDIF
IFDEF WINDOWS
?Windows_MersenneIRandomD LABEL NEAR                       ; alias
public ?Windows_MersenneIRandomD
        push    rdx                                        ; max
        push    rcx                                        ; min
        lea     rcx, MersenneInstance                      ; Pthis = point to instance
        jmp     MersIRandom_max_min_on_stack
...
ENDIF
        push    r8                                         ; max
        push    rdx                                        ; min
MersIRandom_max_min_on_stack label near
...
?Windows_MersIRandomX   LABEL NEAR 
